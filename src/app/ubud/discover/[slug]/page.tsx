// ======================================================
// Route Information
// Original WordPress URLs: post blog dengan prefix /ubud/discover/
// (daftar slug dihasilkan dari POSTS di src/data/posts.ts)
//
// Current Next.js Route:
// src/app/ubud/discover/[slug]/page.tsx
//
// Kenapa prefix ini punya route sendiri: WordPress menerbitkan post di
// beberapa prefix berbeda (/ubud/discover salah satunya). Setiap prefix butuh segmen
