// ======================================================
// Route Information
// Original WordPress URLs: post blog dengan prefix /seminyak/discover/
// (daftar slug dihasilkan dari POSTS di src/data/posts.ts)
//
// Current Next.js Route:
// src/app/seminyak/discover/[slug]/page.tsx
//
// Kenapa prefix ini punya route sendiri: WordPress menerbitkan post di
// beberapa prefix berbeda (/seminyak/discover salah satunya). Setiap prefix butuh segmen
...
const PREFIX = "/seminyak/discover";
